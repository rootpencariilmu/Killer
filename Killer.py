...
def banner():
  ...
  ╚═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦═╦════════════════════════════════════╝
  ╔═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╩═╗
  ║\x1b[33m Github : Pencariilmu\x1b[32m                        ║
  ║\x1b[33m Fb : @ahmadchenwangxuesi\x1b[32m                      ║
  ║\x1b[33m Developers : AnonymousCyberTeam              \x1b[32m ║
  ╚═══════════════════════════════════════════════╝
...
while True:
    try:
        cmd=raw_input(Fore.MAGENTA+'root@Killer\x1b[37m:\x1b[34m~\x1b[37m#\x1b[0m ')
    except:
        banner()
    if cmd=='3':
        break
